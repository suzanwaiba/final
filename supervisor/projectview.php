...
<?php include '../html/dbcon.php';?>
  <section id="sarnuparyo">
    ...
    <table class="content-table">
        ...
        <tbody>
          <?php 
$selectquery = "SELECT pr.project_id, pr.project_name, pr.project_details, pr.project_type, 
u1.username AS member1_name, u2.username AS member2_name, u3.username AS member3_name, u4.username AS member4_name,
s.supervisor_name
FROM projects pr
...
LEFT JOIN supervisors s ON pr.supervisor = s.supervisor_id";
